...
### Models
<ul>
  <li><b>Thermophysical models:</b>
    <ul>
      <li><a href="https://github.com/phayne/PTM3D" target="\_blank">PTM3D</a> <span style="color: #888; font-style: italic;">(private)</span> — Planetary Thermal Model 3D</li>
    </ul>
  </li>
</ul>
