    ...
    <ul class="data-list">
      <li>Thermophysical models:
        <ul class="nested-list">
          ...
          <li><a href="https://github.com/phayne/PTM3D" target="_blank">PTM3D</a> <span class="private-note">(private)</span></li>
        </ul>
      </li>
      <li>Atmospheric radiative transfer</li>
      <li><a href="https://github.com/phayne/planet-tools" target="_blank">Reflectance and emission spectroscopy</a></li>
    </ul>
  </div>
</div>
